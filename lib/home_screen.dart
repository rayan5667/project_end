...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<FoodItem> allFoods = [
    FoodItem(name: 'Carrot Burger', category: 'Burger', price: 10.0, imagePath: 'images/sandwich-5930490_1280.jpg'),
    FoodItem(name: 'Cheese Burger', category: 'Burger', price: 20.0, imagePath: 'images/burger-3847279_1280.jpg'),
    FoodItem(name: 'Double Burger', category: 'Burger', price: 90.0, imagePath: 'images/istockphoto-496389174-612x612.jpg'),
    FoodItem(name: 'Meat Burger', category: 'Burger', price: 12.0, imagePath: 'images/sandwich-5930494_1280.jpg'),
    FoodItem(name: 'Cheese Burger', category: 'Burger', price: 10.0, imagePath: 'images/burger-7383718_1280.jpg'),
    FoodItem(name: 'Salad Burger', category: 'Burger', price: 12.0, imagePath: 'images/hamburger-7461299_1280.jpg'),

    FoodItem(name: 'Fattoush Salad', category: 'Salad', price: 8.0, imagePath: 'images/istockphoto-1425572827-612x612.jpg'),
    FoodItem(name: 'Brocoli 1 Salad', category: 'Salad', price: 9.0, imagePath: 'images/istockphoto-166130816-612x612.jpg'),
    FoodItem(name: 'Brocoli 2 Salad', category: 'Salad', price: 8.0, imagePath: 'images/istockphoto-1394777972-612x612.jpg'),
    FoodItem(name: 'Meat Salad', category: 'Salad', price: 9.0, imagePath: 'images/istockphoto-169986941-612x612.jpg'),
    FoodItem(name: 'Onion Salad', category: 'Salad', price: 8.0, imagePath: 'images/istockphoto-937016542-612x612.jpg'),
    FoodItem(name: 'Cabbage Salad', category: 'Salad', price: 9.0, imagePath: 'images/istockphoto-505685702-612x612.jpg'),

    FoodItem(name: 'Orange', category: 'Drinks', price: 3.0, imagePath: 'images/istockphoto-1144350231-612x612.jpg'),
    FoodItem(name: 'Cherry', category: 'Drinks', price: 4.0, imagePath: 'images/istockphoto-545099646-612x612.jpg'),
    FoodItem(name: 'Apple', category: 'Drinks', price: 3.0, imagePath: 'images/istockphoto-1152441440-612x612.jpg'),
    FoodItem(name: 'Mandarin', category: 'Drinks', price: 4.0, imagePath: 'images/istockphoto-1323890695-2048x2048.jpg'),
    ...
    FoodItem(name: 'Margherita Pizza', category: 'Pizza', price: 11.0, imagePath: 'images/istockphoto-153784617-612x612.jpg'),
    FoodItem(name: 'Cheese Pizza', category: 'Pizza', price: 10.0, imagePath: 'images/istockphoto-184946701-612x612.jpg'),
    FoodItem(name: 'Patate Pizza', category: 'Pizza', price: 11.0, imagePath: 'images/istockphoto-1414575281-612x612.jpg'),
    FoodItem(name: 'Veggie Pizza', category: 'Pizza', price: 10.0, imagePath: 'images/istockphoto-1442417585-612x612.jpg'),

    FoodItem(name: 'Chickens Fried ', category: 'Chickens', price: 13.0, imagePath: 'images/istockphoto-1369101558-612x612.jpg'),
    FoodItem(name: 'Chickens Roasted ', category: 'Chickens', price: 14.0, imagePath: 'images/istockphoto-502474519-612x612.jpg'),
    FoodItem(name: 'Chickens Crispy', category: 'Chickens', price: 13.0, imagePath: 'images/istockphoto-835903320-612x612.jpg'),
    FoodItem(name: 'Chickens Wings ', category: 'Chickens', price: 14.0, imagePath: 'images/istockphoto-467639228-612x612.jpg'),
    FoodItem(name: 'Chickens Strips', category: 'Chickens', price: 13.0, imagePath: 'images/istockphoto-531469196-612x612.jpg'),
    FoodItem(name: 'Chickens Sweet', category: 'Chickens', price: 14.0, imagePath: 'images/istockphoto-491487758-612x612.jpg'),
  ];
